...
function initializeTeams(){
    return new Promise(function(resolve, reject){
        $.ajax({
            url: "https://immense-dusk-84099.herokuapp.com/teams-raw",
            type: "GET",
...
function initializeProjects(){
    return new Promise(function(resolve, reject){
        $.ajax({
            url: "https://immense-dusk-84099.herokuapp.com/projects",
            type: "GET",
            contentType: "application/json"
        })
        .done(function(data){
...
function saveTeam(){
    ...
    $.ajax({
        url: "https://immense-dusk-84099.herokuapp.com/team/"+currentTeam._id(),
        type: "PUT",
        data: JSON.stringify(
            {
